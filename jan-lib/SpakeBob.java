 ...
 * @author Jan Kubeša
 */
public class SpakeBob {
    static SpakeAlice alice = new SpakeAlice();
    public static void main(String[] args) throws IOException {
        ...
        ECPoint bigS = alice.bigS;
        ECPoint shared1 = bigS.subtract(bigN.multiply(PIN)).multiply(smallx);
        ECPoint shared2 = alice.calculateShared(bigT);
    ...
    public void sendT(ECPoint bigT) {}
